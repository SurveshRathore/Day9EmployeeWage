...
{
    //UC6CalcWageHourDay class 
    internal class UC6CalcWageHourDay
    {
        //calculating the wages till a condition of total working hours or days is reached for a month
        public void CalcWageForWorkingHourDay ()
        {
            //variable to store the employee hourly rate
            int EMP_HOUR_RATE = 80;
            //variable to set the hours per month
            int EMP_MONTH_HOURS = 100;
